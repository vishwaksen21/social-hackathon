    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-6 pb-14 md:pt-12 md:pb-20">
      ...
      <div className="text-center mb-10 md:mb-14">
        <h1 className="font-poppins font-black uppercase text-3xl sm:text-4xl md:text-6xl mb-4">
          Hackathon <span className="text-primary">Results</span>
        </h1>
      ...
      {/* Software */}
      <ResultsCard title="Software Track" data={SHORTLISTED_SOFTWARE} />

      {/* Hardware */}
      <ResultsCard title="Hardware Track" data={SHORTLISTED_HARDWARE} />
...
function ResultsCard({
  ...
  return (
    <div className="mb-10">
      ...
      <InteractiveCard className="card-glass p-4 sm:p-6 md:p-8 rounded-2xl border border-white/10 bg-white/[0.03]">
        ...
        <div className="overflow-auto max-h-[400px] rounded-lg border border-white/10">
          ...
          <table className="w-full min-w-[700px] text-sm text-left text-white/80">
            ...
            {/* Sticky Header */}
            <thead className="text-xs text-primary uppercase bg-white/5 sticky top-0 z-10">
              <tr>
